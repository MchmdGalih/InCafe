<template>
  <footer>
    <div
      class="grid grid-cols-2 lg:grid-cols-4 grid-flow-row bg-amber-900 font-secondary px-8 gap-2 py-28 sm:px-24 lg:px-16 lg:py-10"
    >
      <!-- Main Info -->
      <div class="col-span-1 space-y-4">
        ...
        <!-- Address -->
        <p class="text-medium-gray max-w-96 text-slate-50">
        ...
        <div class="flex flex-row gap-x-2">
          <button
            class="bg-white hover:hover:bg-amber-900 transition-colors duration-500 rounded-md hover:text-white p-1 h-10 w-10 flex justify-center items-center"
          >
      ...
      <!-- News Letter -->
      <div class="col-span-1 space-y-4 text-slate-50">
